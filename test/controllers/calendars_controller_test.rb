...
class CalendarsControllerTest < ActionController::TestCase
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post :create, calendar: { day: @calendar.day, hiduke: @calendar.hiduke, holiday: @calendar.holiday, month: @calendar.month, year: @calendar.year }
    end
  ...
  test "should update calendar" do
    patch :update, id: @calendar, calendar: { day: @calendar.day, hiduke: @calendar.hiduke, holiday: @calendar.holiday, month: @calendar.month, year: @calendar.year }
    assert_redirected_to calendar_path(assigns(:calendar))
  end
